...
public class ProductController {
	...
	public String toAdd(Model model) {
		...
		cn.itcast.core.bean.product.TypeQuery.Criteria criteria = typeQuery.createCriteria();
		criteria.andParentIdNotEqualTo(0l);
		List<cn.itcast.core.bean.product.Type> types = typeService.selectTypeListByQuery(typeQuery);
