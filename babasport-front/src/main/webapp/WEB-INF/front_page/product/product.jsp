...
<div class="bar"><div class="bar_w">
	...
	<ul class="r uls">
	<li class="dev">您好,欢迎${USER_SESSION}来到新巴巴运动网！</li>
	<c:if test="${!isLogin }">
			...
			<div class="mt ofc">
				...
				<c:forEach items="${pagination.list}" var="product" >
					<li>
						...
						<dl>
							<!-- dt 10个文字+... -->
							<dt><a href="javascript:void(0)" onclick="window.open('http://localhost:8080/html/product/${product.id}.html')" title="${product.name}" target="_blank">${product.name}</a></dt>
