		...
		<ul class="uls form">
			...
			<li><label>选择颜色：</label>
				<div id="colors" class="pre spec">
					...
					<a onclick="colorToRed(this,'${color.id}')" href="javascript:void(0)" title="${color.name}" class="changToRed"><img width="25" height="25" data-img="1" src="/res/img/pic/ppp00.jpg" alt="${color.name} "><i>${color.name}</i></a>
					</c:forEach>
				</div>
			</li>
